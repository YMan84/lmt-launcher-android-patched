...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v1, p0, Landroid/support/design/widget/NavigationView;->menu:Landroid/support/design/internal/NavigationMenu;

    .line 114
    sget-object v4, Landroid/support/design/R$styleable;->NavigationView:[I

    sget v6, Landroid/support/design/R$style;->Widget_Design_NavigationView:I
    ...
    .line 115
    invoke-static/range {v2 .. v7}, Landroid/support/design/internal/ThemeEnforcement;->obtainTintedStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/support/v7/widget/TintTypedArray;
    ...
    .line 125
    invoke-virtual {p2, p3, v8}, Landroid/support/v7/widget/TintTypedArray;->getDimensionPixelSize(II)I
    ...
    .line 128
    invoke-virtual {p2, p3, v8}, Landroid/support/v7/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    .line 141
    :goto_0
    sget v2, Landroid/support/design/R$styleable;->NavigationView_itemTextAppearance:I
    ...
    invoke-virtual {p2, v2, v8}, Landroid/support/v7/widget/TintTypedArray;->getResourceId(II)I
    ...
    invoke-virtual {p2, v6}, Landroid/support/v7/widget/TintTypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 160
    invoke-virtual {p2, v7, v8}, Landroid/support/v7/widget/TintTypedArray;->getDimensionPixelSize(II)I

    move-result v7

    .line 161
    invoke-virtual {v0, v7}, Landroid/support/design/internal/NavigationMenuPresenter;->setItemHorizontalPadding(I)V
    ...
    .line 176
    invoke-virtual {v0, v3}, Landroid/support/design/internal/NavigationMenuPresenter;->setId(I)V
    ...
    .line 180
    invoke-virtual {v0, v2}, Landroid/support/design/internal/NavigationMenuPresenter;->setItemTextAppearance(I)V
    ...
    .line 183
    invoke-virtual {v0, v6}, Landroid/support/design/internal/NavigationMenuPresenter;->setItemBackground(Landroid/graphics/drawable/Drawable;)V

    .line 184
    invoke-virtual {v0, v7}, Landroid/support/design/internal/NavigationMenuPresenter;->setItemIconPadding(I)V
    ...
    invoke-virtual {p2, p1, v8}, Landroid/support/v7/widget/TintTypedArray;->getResourceId(II)I
