...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v3, p0, Landroid/support/design/widget/TextInputLayout;->inputFrame:Landroid/widget/FrameLayout;
    ...
    invoke-virtual {v0, v3}, Landroid/support/design/widget/CollapsingTextHelper;->setTextSizeInterpolator(Landroid/animation/TimeInterpolator;)V

    .line 262
    sget-object v3, Landroid/support/design/animation/AnimationUtils;->LINEAR_INTERPOLATOR:Landroid/animation/TimeInterpolator;

    invoke-virtual {v0, v3}, Landroid/support/design/widget/CollapsingTextHelper;->setPositionInterpolator(Landroid/animation/TimeInterpolator;)V
    ...
    sget v0, Landroid/support/design/R$dimen;->mtrl_textinput_box_bottom_offset:I
    ...
    sget v0, Landroid/support/design/R$dimen;->mtrl_textinput_box_label_cutout_padding:I
    ...
    .line 285
    invoke-virtual {p2, p3, v2}, Landroid/support/v7/widget/TintTypedArray;->getDimensionPixelOffset(II)I
    ...
    .line 287
    invoke-virtual {p2, p3, v0}, Landroid/support/v7/widget/TintTypedArray;->getDimension(IF)F
    ...
    .line 295
    invoke-virtual {p2, p3, v2}, Landroid/support/v7/widget/TintTypedArray;->getColor(II)I
    ...
    sget v0, Landroid/support/design/R$dimen;->mtrl_textinput_box_stroke_width_default:I
    ...
    .line 334
    invoke-virtual {p2, v4, v2}, Landroid/support/v7/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    invoke-virtual {p2, v6, v2}, Landroid/support/v7/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    invoke-virtual {p2, v7, v2}, Landroid/support/v7/widget/TintTypedArray;->getResourceId(II)I
    ...
    invoke-virtual {p2, v7, v2}, Landroid/support/v7/widget/TintTypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, p0, Landroid/support/design/widget/TextInputLayout;->passwordToggleEnabled:Z

    .line 344
    sget v2, Landroid/support/design/R$styleable;->TextInputLayout_passwordToggleDrawable:I

    invoke-virtual {p2, v2}, Landroid/support/v7/widget/TintTypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    iput-object v2, p0, Landroid/support/design/widget/TextInputLayout;->passwordToggleDrawable:Landroid/graphics/drawable/Drawable;

    .line 345
    sget v2, Landroid/support/design/R$styleable;->TextInputLayout_passwordToggleContentDescription:I

    .line 346
    invoke-virtual {p2, v2}, Landroid/support/v7/widget/TintTypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object v2

    iput-object v2, p0, Landroid/support/design/widget/TextInputLayout;->passwordToggleContentDesc:Ljava/lang/CharSequence;
    ...
    .line 348
    iput-boolean v1, p0, Landroid/support/design/widget/TextInputLayout;->hasPasswordToggleTintList:Z
    ...
    iput-object v2, p0, Landroid/support/design/widget/TextInputLayout;->passwordToggleTintList:Landroid/content/res/ColorStateList;
    ...
    .line 352
    iput-boolean v1, p0, Landroid/support/design/widget/TextInputLayout;->hasPasswordToggleTintMode:Z

    .line 353
    sget v1, Landroid/support/design/R$styleable;->TextInputLayout_passwordToggleTintMode:I

    .line 355
    invoke-virtual {p2, v1, p3}, Landroid/support/v7/widget/TintTypedArray;->getInt(II)I
    ...
    .line 354
    invoke-static {p3, v1}, Landroid/support/design/internal/ViewUtils;->parseTintMode(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
...
.method private applyPasswordToggleTint()V
    ...
    iget-boolean v1, p0, Landroid/support/design/widget/TextInputLayout;->hasPasswordToggleTintMode:Z
