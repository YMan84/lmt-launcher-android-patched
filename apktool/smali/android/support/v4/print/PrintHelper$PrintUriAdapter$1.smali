...
.method protected onCancelled(Landroid/graphics/Bitmap;)V
    ...
    invoke-static {p1}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintDocumentAdapter$LayoutResultCallback;)V
...
.method protected onPostExecute(Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v0}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes;)Landroid/print/PrintAttributes$MediaSize;
    ...
    .line 463
    invoke-static {v0}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes$MediaSize;)Z
    ...
    .line 477
    invoke-static {p1, v1}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintDocumentInfo$Builder;I)Landroid/print/PrintDocumentInfo$Builder;

    move-result-object p1

    .line 478
    invoke-static {p1, v1}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/print/PrintDocumentInfo$Builder;I)Landroid/print/PrintDocumentInfo$Builder;

    move-result-object p1

    .line 479
    invoke-static {p1}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintDocumentInfo$Builder;)Landroid/print/PrintDocumentInfo;
    ...
    invoke-static {v2, v3}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes;Ljava/lang/Object;)Z
    ...
    invoke-static {v2, p1, v1}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintDocumentAdapter$LayoutResultCallback;Landroid/print/PrintDocumentInfo;Z)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintDocumentAdapter$LayoutResultCallback;Ljava/lang/CharSequence;)V
...
.method protected onPreExecute()V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/os/CancellationSignal;Landroid/os/CancellationSignal$OnCancelListener;)V
