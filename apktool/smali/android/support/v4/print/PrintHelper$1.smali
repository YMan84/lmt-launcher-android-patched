...
.method protected varargs doInBackground([Ljava/lang/Void;)Ljava/lang/Throwable;
    ...
    invoke-static {p1}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/os/CancellationSignal;)Z
    ...
    .line 647
    invoke-static {v2}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes;)I
    ...
    invoke-static {v2}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/os/CancellationSignal;)Z
    ...
    .line 654
    :try_start_1
    invoke-static {p1, v2}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/pdf/PrintedPdfDocument;I)Landroid/graphics/pdf/PdfDocument$Page;
    ...
    invoke-static {v3}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/pdf/PdfDocument$Page;)Landroid/graphics/pdf/PdfDocument$PageInfo;

    move-result-object v4

    invoke-static {v4}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/pdf/PdfDocument$PageInfo;)Landroid/graphics/Rect;
    ...
    .line 664
    invoke-static {v4, v2}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/pdf/PrintedPdfDocument;I)Landroid/graphics/pdf/PdfDocument$Page;
    ...
    invoke-static {v2}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/pdf/PdfDocument$Page;)Landroid/graphics/pdf/PdfDocument$PageInfo;

    move-result-object v6

    invoke-static {v6}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/pdf/PdfDocument$PageInfo;)Landroid/graphics/Rect;
    ...
    .line 666
    invoke-static {v4, v2}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/pdf/PrintedPdfDocument;Landroid/graphics/pdf/PdfDocument$Page;)V

    .line 667
    invoke-static {v4}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/pdf/PrintedPdfDocument;)V
    ...
    .line 682
    invoke-static {v3}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/pdf/PdfDocument$Page;)Landroid/graphics/Canvas;
    ...
    .line 689
    invoke-static {p1, v3}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/pdf/PrintedPdfDocument;Landroid/graphics/pdf/PdfDocument$Page;)V
    ...
    .line 700
    :try_start_2
    invoke-static {p1}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/pdf/PrintedPdfDocument;)V
    ...
    .line 696
    invoke-static {p1, v2}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/pdf/PrintedPdfDocument;Ljava/io/OutputStream;)V
    :try_end_5
...
.method protected onPostExecute(Ljava/lang/Throwable;)V
    ...
    invoke-static {v0}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/os/CancellationSignal;)Z
    ...
    invoke-static {p1}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    ...
    invoke-static {}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m()Landroid/print/PageRange;

    move-result-object v2

    aput-object v2, v0, v1

    invoke-static {p1, v0}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintDocumentAdapter$WriteResultCallback;[Landroid/print/PageRange;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintDocumentAdapter$WriteResultCallback;Ljava/lang/CharSequence;)V
