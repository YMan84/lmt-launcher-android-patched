...
.method public static makeBasic()Landroid/support/v4/app/ActivityOptionsCompat;
    ...
    invoke-static {}, Landroid/support/v4/app/NavUtils$$ExternalSyntheticApiModelOutline0;->m$1()Landroid/app/ActivityOptions;
...
.method public static makeClipRevealAnimation(Landroid/view/View;IIII)Landroid/support/v4/app/ActivityOptionsCompat;
    ...
    invoke-static {p0, p1, p2, p3, p4}, Landroid/support/design/chip/Chip$$ExternalSyntheticApiModelOutline0;->m(Landroid/view/View;IIII)Landroid/app/ActivityOptions;
...
.method public static makeCustomAnimation(Landroid/content/Context;II)Landroid/support/v4/app/ActivityOptionsCompat;
    ...
    invoke-static {p0, p1, p2}, Landroid/support/v4/app/NavUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/Context;II)Landroid/app/ActivityOptions;
...
.method public static makeScaleUpAnimation(Landroid/view/View;IIII)Landroid/support/v4/app/ActivityOptionsCompat;
    ...
    invoke-static {p0, p1, p2, p3, p4}, Landroid/support/v4/app/NavUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/view/View;IIII)Landroid/app/ActivityOptions;
...
.method public static makeSceneTransitionAnimation(Landroid/app/Activity;Landroid/view/View;Ljava/lang/String;)Landroid/support/v4/app/ActivityOptionsCompat;
    ...
    invoke-static {p0, p1, p2}, Landroid/support/v4/app/NavUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/Activity;Landroid/view/View;Ljava/lang/String;)Landroid/app/ActivityOptions;
...
.method public static varargs makeSceneTransitionAnimation(Landroid/app/Activity;[Landroid/support/v4/util/Pair;)Landroid/support/v4/app/ActivityOptionsCompat;
    ...
    .line 217
    invoke-static {p0, v0}, Landroid/support/v4/app/NavUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/Activity;[Landroid/util/Pair;)Landroid/app/ActivityOptions;
...
.method public static makeTaskLaunchBehind()Landroid/support/v4/app/ActivityOptionsCompat;
    ...
    invoke-static {}, Landroid/support/v4/app/NavUtils$$ExternalSyntheticApiModelOutline0;->m()Landroid/app/ActivityOptions;
...
.method public static makeThumbnailScaleUpAnimation(Landroid/view/View;Landroid/graphics/Bitmap;II)Landroid/support/v4/app/ActivityOptionsCompat;
    ...
    invoke-static {p0, p1, p2, p3}, Landroid/support/v4/app/NavUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/view/View;Landroid/graphics/Bitmap;II)Landroid/app/ActivityOptions;
