...
.method private static closeQuietly(Ljava/lang/AutoCloseable;)V
    ...
    .line 168
    :try_start_0
    invoke-static {p0}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/AutoCloseable;)V
    :try_end_0
...
.method private static createFile(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {p0, p1, p2, p3}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
...
.method public delete()Z
    ...
    invoke-static {v0, v1}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
...
.method public listFiles()[Landroid/support/v4/provider/DocumentFile;
    ...
    .line 138
    invoke-static {v0}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/net/Uri;)Ljava/lang/String;

    move-result-object v2

    .line 137
    invoke-static {v0, v2}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {v2, v1}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
...
.method public renameTo(Ljava/lang/String;)Z
    ...
    .line 179
    invoke-static {v1, v2, p1}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
