...
.method private createStaticLayoutForMeasuring(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    invoke-static {v0}, Landroid/support/v7/widget/MenuPopupWindow$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/text/TextDirectionHeuristic;
    ...
    .line 715
    invoke-static {p1, v3, v1, v2, p3}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/CharSequence;IILandroid/text/TextPaint;I)Landroid/text/StaticLayout$Builder;

    move-result-object p1

    .line 718
    invoke-static {p1, p2}, Landroid/support/v7/widget/MenuPopupWindow$$ExternalSyntheticApiModelOutline0;->m(Landroid/text/StaticLayout$Builder;Landroid/text/Layout$Alignment;)Landroid/text/StaticLayout$Builder;
    ...
    .line 720
    invoke-static {p2}, Landroid/support/v7/widget/MenuPopupWindow$$ExternalSyntheticApiModelOutline0;->m(Landroid/widget/TextView;)F
    ...
    .line 721
    invoke-static {p3}, Landroid/support/v7/widget/MenuPopupWindow$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/widget/TextView;)F

    move-result p3

    .line 719
    invoke-static {p1, p2, p3}, Landroid/support/v7/widget/MenuPopupWindow$$ExternalSyntheticApiModelOutline0;->m(Landroid/text/StaticLayout$Builder;FF)Landroid/text/StaticLayout$Builder;
    ...
    .line 722
    invoke-static {p2}, Landroid/support/v4/widget/DrawerLayout$$ExternalSyntheticApiModelOutline0;->m(Landroid/widget/TextView;)Z

    move-result p2

    invoke-static {p1, p2}, Landroid/support/v7/widget/MenuPopupWindow$$ExternalSyntheticApiModelOutline0;->m(Landroid/text/StaticLayout$Builder;Z)Landroid/text/StaticLayout$Builder;
    ...
    .line 723
    invoke-static {p2}, Landroid/support/v4/widget/DrawerLayout$$ExternalSyntheticApiModelOutline0;->m$8(Landroid/widget/TextView;)I

    move-result p2

    invoke-static {p1, p2}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/text/StaticLayout$Builder;I)Landroid/text/StaticLayout$Builder;
    ...
    .line 724
    invoke-static {p2}, Landroid/support/v4/widget/DrawerLayout$$ExternalSyntheticApiModelOutline0;->m$9(Landroid/widget/TextView;)I

    move-result p2

    invoke-static {p1, p2}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/text/StaticLayout$Builder;I)Landroid/text/StaticLayout$Builder;
    ...
    .line 725
    :cond_0
    invoke-static {p1, p4}, Landroid/support/v7/widget/MenuPopupWindow$$ExternalSyntheticApiModelOutline0;->m(Landroid/text/StaticLayout$Builder;I)Landroid/text/StaticLayout$Builder;

    move-result-object p1

    .line 726
    invoke-static {p1, v0}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/text/StaticLayout$Builder;Landroid/text/TextDirectionHeuristic;)Landroid/text/StaticLayout$Builder;

    move-result-object p1

    .line 727
    invoke-static {p1}, Landroid/support/v4/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/text/StaticLayout$Builder;)Landroid/text/StaticLayout;
...
.method private createStaticLayoutForMeasuringPre23(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
    ...
    invoke-static {v0}, Landroid/support/v7/widget/MenuPopupWindow$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/widget/TextView;)F
    ...
    invoke-static {v1}, Landroid/support/v7/widget/MenuPopupWindow$$ExternalSyntheticApiModelOutline0;->m(Landroid/widget/TextView;)F
    ...
    invoke-static {v2}, Landroid/support/v4/widget/DrawerLayout$$ExternalSyntheticApiModelOutline0;->m(Landroid/widget/TextView;)Z
...
.method private setRawTextSize(F)V
    ...
    invoke-static {p1}, Landroid/support/v7/widget/MenuPopupWindow$$ExternalSyntheticApiModelOutline0;->m(Landroid/widget/TextView;)Z
...
.method private suggestedSizeFitsInSpace(ILandroid/graphics/RectF;)Z
    ...
    invoke-static {v1}, Landroid/support/v4/widget/DrawerLayout$$ExternalSyntheticApiModelOutline0;->m$2(Landroid/widget/TextView;)I
