...
public abstract class Transition implements Cloneable {
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    android.support.transition.TransitionValues getMatchedTransitionValues(android.view.View r6, boolean r7) {
        /*
            r5 = this;
            android.support.transition.TransitionSet r0 = r5.mParent
            if (r0 == 0) goto L9
            android.support.transition.TransitionValues r6 = r0.getMatchedTransitionValues(r6, r7)
            return r6
        L9:
            if (r7 == 0) goto Le
            java.util.ArrayList<android.support.transition.TransitionValues> r0 = r5.mStartValuesList
            goto L10
        Le:
            java.util.ArrayList<android.support.transition.TransitionValues> r0 = r5.mEndValuesList
        L10:
            r1 = 0
            if (r0 != 0) goto L14
            return r1
        ...
        L2d:
            if (r3 < 0) goto L3d
            if (r7 == 0) goto L34
            java.util.ArrayList<android.support.transition.TransitionValues> r6 = r5.mEndValuesList
            goto L36
        L34:
    ...
    void playTransition(ViewGroup viewGroup) {
        ...
        for (int i = size - 1; i >= 0; i--) {
            ...
            if (animatorKeyAt != null && (animationInfo = runningAnimators.get(animatorKeyAt)) != null && animationInfo.mView != null && windowId.equals(animationInfo.mWindowId)) {
                ...
                if ((!(transitionValues2 == null && matchedTransitionValues == null) && animationInfo.mTransition.isTransitionRequired(transitionValues, matchedTransitionValues)) ? true : DBG) {
    ...
    protected void end() {
        ...
        if (i == 0) {
            ...
            for (int i3 = 0; i3 < this.mStartValues.mItemIdValues.size(); i3++) {
                ...
                if (viewValueAt != null) {
                    ViewCompat.setHasTransientState(viewValueAt, DBG);
                }
            }
            for (int i4 = 0; i4 < this.mEndValues.mItemIdValues.size(); i4++) {
                ...
                if (viewValueAt2 != null) {
                    ViewCompat.setHasTransientState(viewValueAt2, DBG);
                }
            }
            this.mEnded = true;
        }
