...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo18clone = transition.mo18clone();
        transitionMo18clone.setSceneRoot(sceneRoot);
        Scene currentScene = Scene.getCurrentScene(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo18clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo18clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo18clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo18clone = transition.mo18clone();
        sceneChangeSetup(viewGroup, transitionMo18clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo18clone);
    }
