...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    static {
        boolean z = Build.VERSION.SDK_INT < 21 ? true : DEBUG;
        IS_PRE_LOLLIPOP = z;
    ...
    public boolean hasWindowFeature(int i) {
        ...
        if (iSanitizeWindowFeatureId == 1) {
            ...
            z = iSanitizeWindowFeatureId != 109 ? DEBUG : this.mOverlayActionBar;
        }
    ...
    ActionMode startSupportActionModeFromWindow(ActionMode.Callback callback) {
        ...
        if (actionModeOnWindowStartingSupportActionMode != null) {
            ...
            if (this.mActionModeView != null) {
                ...
                StandaloneActionMode standaloneActionMode = new StandaloneActionMode(this.mActionModeView.getContext(), this.mActionModeView, callback, this.mActionModePopup != null ? DEBUG : true);
    ...
    boolean dispatchKeyEvent(KeyEvent keyEvent) {
        ...
        return keyEvent.getAction() != 0 ? DEBUG : true ? onKeyDown(keyCode, keyEvent) : onKeyUp(keyCode, keyEvent);
    }
    ...
    boolean onKeyDown(int i, KeyEvent keyEvent) {
        if (i == 4) {
            this.mLongPressBackDown = (keyEvent.getFlags() & 128) == 0 ? DEBUG : true;
        } else if (i == 82) {
    ...
    private void openPanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        if (panelFeatureState.featureId == 0) {
            if ((this.mContext.getResources().getConfiguration().screenLayout & 15) == 4 ? true : DEBUG) {
                return;
            }
        }
        Window.Callback windowCallback = getWindowCallback();
    ...
    private boolean preparePanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        boolean z = (panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) ? true : DEBUG;
        ...
        if (panelFeatureState.createdPanelView == null && (!z || !(peekSupportActionBar() instanceof ToolbarActionBar))) {
            ...
            panelFeatureState.qwertyMode = KeyCharacterMap.load(keyEvent != null ? keyEvent.getDeviceId() : -1).getKeyboardType() != 1 ? true : DEBUG;
    ...
    int updateStatusGuard(int i) {
        ...
        if (actionBarContextView == null || !(actionBarContextView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                z = this.mStatusGuard == null ? DEBUG : true;
