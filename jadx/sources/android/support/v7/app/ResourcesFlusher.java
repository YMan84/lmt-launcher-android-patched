...
class ResourcesFlusher {
    ...
    private static void flushThemedResourcesCache(Object obj) {
        LongSparseArray longSparseArrayM;
        ...
        try {
            longSparseArrayM = DrawerLayout$$ExternalSyntheticApiModelOutline0.m(field.get(obj));
        } catch (IllegalAccessException e3) {
            Log.e(TAG, "Could not retrieve value from ThemedResourceCache#mUnthemedEntries", e3);
            longSparseArrayM = null;
        }
        if (longSparseArrayM != null) {
            longSparseArrayM.clear();
        }
    }
