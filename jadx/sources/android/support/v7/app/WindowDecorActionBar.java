...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        ...
        boolean z = (this.mDecorToolbar.getDisplayOptions() & 4) != 0 ? true : $assertionsDisabled;
        if (z) {
            this.mDisplayHomeAsUpSet = true;
        }
        ActionBarPolicy actionBarPolicy = ActionBarPolicy.get(this.mContext);
        setHomeButtonEnabled((actionBarPolicy.enableHomeButtonByDefault() || z) ? true : $assertionsDisabled);
    ...
    private void setHasEmbeddedTabs(boolean z) {
        ...
        boolean z2 = getNavigationMode() == 2 ? true : $assertionsDisabled;
        ...
        this.mDecorToolbar.setCollapsible((this.mHasEmbeddedTabs || !z2) ? $assertionsDisabled : true);
        this.mOverlayLayout.setHasNonEmbeddedTabs((this.mHasEmbeddedTabs || !z2) ? $assertionsDisabled : true);
    }
    ...
    public void setNavigationMode(int i) {
        ...
        this.mDecorToolbar.setCollapsible((i != 2 || this.mHasEmbeddedTabs) ? $assertionsDisabled : true);
    ...
    public boolean onKeyShortcut(int i, KeyEvent keyEvent) {
        ...
        menu.setQwertyMode(KeyCharacterMap.load(keyEvent != null ? keyEvent.getDeviceId() : -1).getKeyboardType() == 1 ? $assertionsDisabled : true);
