...
class AppCompatTextViewAutoSizeHelper {
    ...
    private StaticLayout createStaticLayoutForMeasuring(CharSequence charSequence, Layout.Alignment alignment, int i, int i2) {
        TextDirectionHeuristic textDirectionHeuristicM = MenuPopupWindow$$ExternalSyntheticApiModelOutline0.m(invokeAndReturnWithDefault(this.mTextView, "getTextDirectionHeuristic", TextDirectionHeuristics.FIRSTSTRONG_LTR));
        ...
        return hyphenationFrequency.setMaxLines(i2).setTextDirection(textDirectionHeuristicM).build();
    }
