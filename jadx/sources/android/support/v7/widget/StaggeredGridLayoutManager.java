...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    */
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler recycler, RecyclerView.State state, View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        if (this.mOrientation == 0) {
            accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(layoutParams2.getSpanIndex(), layoutParams2.mFullSpan ? this.mSpanCount : 1, -1, -1, layoutParams2.mFullSpan, DEBUG));
        } else {
            accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(-1, -1, layoutParams2.getSpanIndex(), layoutParams2.mFullSpan ? this.mSpanCount : 1, layoutParams2.mFullSpan, DEBUG));
        }
    }
    ...
    */
    ...
    private void setLayoutStateDirection(int i) {
        ...
        this.mLayoutState.mItemDirection = this.mShouldReverseLayout != (i == -1 ? true : DEBUG) ? -1 : 1;
    }
    ...
    */
    ...
    public View onFocusSearchFailed(View view, int i, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        boolean z2 = (this.mReverseLayout ^ true) == (iConvertFocusDirectionToLayoutDirection == -1 ? true : DEBUG) ? true : DEBUG;
        if (!z) {
            if (z2) {
    ...
    class Span {
        ...
        int findOnePartiallyOrCompletelyVisibleChild(int i, int i2, boolean z, boolean z2, boolean z3) {
            ...
            while (i != i2) {
                ...
                boolean z5 = (!z3 ? decoratedStart < endAfterPadding : decoratedStart <= endAfterPadding) ? StaggeredGridLayoutManager.DEBUG : true;
    ...
    public static class SavedState implements Parcelable {
        ...
        SavedState(Parcel parcel) {
            ...
            this.mReverseLayout = i3 == 1 ? true : StaggeredGridLayoutManager.DEBUG;
