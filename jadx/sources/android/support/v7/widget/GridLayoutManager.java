...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler recycler, RecyclerView.State state, View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        if (this.mOrientation == 0) {
            accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(layoutParams2.getSpanIndex(), layoutParams2.getSpanSize(), spanGroupIndex, 1, (this.mSpanCount <= 1 || layoutParams2.getSpanSize() != this.mSpanCount) ? DEBUG : true, DEBUG));
        } else {
            accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(spanGroupIndex, 1, layoutParams2.getSpanIndex(), layoutParams2.getSpanSize(), (this.mSpanCount <= 1 || layoutParams2.getSpanSize() != this.mSpanCount) ? DEBUG : true, DEBUG));
        }
    }
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        boolean z2 = modeInOther != 1073741824 ? true : DEBUG;
        int i6 = getChildCount() > 0 ? this.mCachedBorders[this.mSpanCount] : 0;
        if (z2) {
            updateMeasurements();
        }
        boolean z3 = layoutState.mItemDirection == 1 ? true : DEBUG;
        ...
        for (int i14 = 0; i14 < i10; i14++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i11) {
                ...
                if (this.mOrientation == 1) {
                    childMeasureSpec2 = getChildMeasureSpec(spaceForSpanRange, 1073741824, i16, layoutParams.width, DEBUG);
                    ...
                    childMeasureSpec = getChildMeasureSpec(spaceForSpanRange, 1073741824, i15, layoutParams.height, DEBUG);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:58:0x00d8, code lost:
        ...
        if (r13 == (r2 > r15 ? true : android.support.v7.widget.GridLayoutManager.DEBUG)) goto L48;
     */
