...
public class NotificationCompat {
                ...
                try {
                    if (bundle.containsKey(KEY_TEXT) && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            personBuild = Person.fromAndroidPerson(Person$$ExternalSyntheticApiModelOutline0.m45m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
                ...
                if (Build.VERSION.SDK_INT >= 16 && parcelableArrayList != null) {
                    ...
                    for (int i = 0; i < size; i++) {
                        if (Build.VERSION.SDK_INT >= 20) {
                            actionArr[i] = NotificationCompat.getActionCompatFromAction(Person$$ExternalSyntheticApiModelOutline0.m(parcelableArrayList.get(i)));
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle bundle) {
            ...
            android.app.RemoteInput remoteInputM21m = NavUtils$$ExternalSyntheticApiModelOutline0.m21m((Object) bundle.getParcelable(KEY_REMOTE_INPUT));
            String[] stringArray = bundle.getStringArray(KEY_PARTICIPANTS);
            if (stringArray == null || stringArray.length != 1) {
                return null;
            }
            return new UnreadConversation(strArr, remoteInputM21m != null ? new RemoteInput(remoteInputM21m.getResultKey(), remoteInputM21m.getLabel(), remoteInputM21m.getChoices(), remoteInputM21m.getAllowFreeFormInput(), remoteInputM21m.getExtras(), null) : null, pendingIntent2, pendingIntent, stringArray, bundle.getLong(KEY_TIMESTAMP));
        }
