...
public final class NotificationManagerCompat {
    ...
    public boolean areNotificationsEnabled() {
        ...
        AppOpsManager appOpsManagerM = NavUtils$$ExternalSyntheticApiModelOutline0.m(this.mContext.getSystemService("appops"));
        ApplicationInfo applicationInfo = this.mContext.getApplicationInfo();
        String packageName = this.mContext.getApplicationContext().getPackageName();
        int i = applicationInfo.uid;
        try {
            Class<?> cls = Class.forName(NavUtils$$ExternalSyntheticApiModelOutline0.m31m().getName());
            return ((Integer) cls.getMethod(CHECK_OP_NO_THROW, Integer.TYPE, Integer.TYPE, String.class).invoke(appOpsManagerM, Integer.valueOf(((Integer) cls.getDeclaredField(OP_POST_NOTIFICATION).get(Integer.class)).intValue()), Integer.valueOf(i), packageName)).intValue() == 0;
