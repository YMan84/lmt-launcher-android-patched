...
public final class ColorUtils {
    ...
    public static Color compositeColors(Color color, Color color2) {
        if (!ColorUtils$$ExternalSyntheticBackport7.m(color.getModel(), color2.getModel())) {
            throw new IllegalArgumentException("Color models must match (" + color.getModel() + " vs. " + color2.getModel() + ")");
        }
        if (!ColorUtils$$ExternalSyntheticBackport7.m(color2.getColorSpace(), color.getColorSpace())) {
