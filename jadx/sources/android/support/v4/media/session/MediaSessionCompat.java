...
public class MediaSessionCompat {
            ...
            if (callback == null) {
                ...
                this.mRcc.setMetadataUpdateListener(new RemoteControlClient.OnMetadataUpdateListener() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi19.1
                    ...
                    public void onMetadataUpdate(int i, Object obj) {
                        if (i == 268435457 && MediaSessionCompatApi21$$ExternalSyntheticApiModelOutline0.m148m(obj)) {
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public final MediaSessionManager.RemoteUserInfo getCurrentControllerInfo() {
            return new MediaSessionManager.RemoteUserInfo(MediaSessionCompatApi21$$ExternalSyntheticApiModelOutline0.m132m(this.mSessionObj).getCurrentControllerInfo());
        }
    }
}
