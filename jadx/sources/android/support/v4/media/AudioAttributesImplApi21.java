...
public class AudioAttributesImplApi21 implements AudioAttributesImpl {
    ...
    static Method getAudioAttributesToLegacyStreamTypeMethod() {
        try {
            if (sAudioAttributesToLegacyStreamType == null) {
                sAudioAttributesToLegacyStreamType = RatingCompat$$ExternalSyntheticApiModelOutline0.m109m().getMethod("toLegacyStreamType", RatingCompat$$ExternalSyntheticApiModelOutline0.m109m());
            }
    ...
    public static AudioAttributesImpl fromBundle(Bundle bundle) {
        AudioAttributes audioAttributesM71m;
        if (bundle == null || (audioAttributesM71m = PathUtils$$ExternalSyntheticApiModelOutline0.m71m((Object) bundle.getParcelable("android.support.v4.media.audio_attrs.FRAMEWORKS"))) == null) {
            return null;
        }
        return new AudioAttributesImplApi21(audioAttributesM71m, bundle.getInt("android.support.v4.media.audio_attrs.LEGACY_STREAM_TYPE", -1));
    }
}
