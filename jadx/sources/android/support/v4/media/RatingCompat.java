...
public final class RatingCompat implements Parcelable {
    ...
    public static RatingCompat fromRating(Object obj) {
        ...
        if (obj != null && Build.VERSION.SDK_INT >= 19) {
            int ratingStyle = RatingCompat$$ExternalSyntheticApiModelOutline0.m89m(obj).getRatingStyle();
            if (RatingCompat$$ExternalSyntheticApiModelOutline0.m89m(obj).isRated()) {
                switch (ratingStyle) {
                    case 1:
                        ratingCompatNewUnratedRating = newHeartRating(RatingCompat$$ExternalSyntheticApiModelOutline0.m89m(obj).hasHeart());
                        break;
                    case 2:
                        ratingCompatNewUnratedRating = newThumbRating(RatingCompat$$ExternalSyntheticApiModelOutline0.m89m(obj).isThumbUp());
                        break;
                    case 3:
                    case 4:
                    case 5:
                        ratingCompatNewUnratedRating = newStarRating(ratingStyle, RatingCompat$$ExternalSyntheticApiModelOutline0.m89m(obj).getStarRating());
                        break;
                    case 6:
                        ratingCompatNewUnratedRating = newPercentageRating(RatingCompat$$ExternalSyntheticApiModelOutline0.m89m(obj).getPercentRating());
                        break;
                    default:
                        return null;
                }
