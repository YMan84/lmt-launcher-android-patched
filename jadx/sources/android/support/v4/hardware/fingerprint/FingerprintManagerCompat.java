...
public final class FingerprintManagerCompat {
    ...
    public void authenticate(CryptoObject cryptoObject, int i, CancellationSignal cancellationSignal, AuthenticationCallback authenticationCallback, Handler handler) {
        ...
        fingerprintManagerOrNull.authenticate(wrapCryptoObject(cryptoObject), cancellationSignal != null ? Person$$ExternalSyntheticApiModelOutline0.m49m(cancellationSignal.getCancellationSignalObject()) : null, i, wrapCallback(authenticationCallback), handler);
    }

    private static FingerprintManager getFingerprintManagerOrNull(Context context) {
        if (context.getPackageManager().hasSystemFeature("android.hardware.fingerprint")) {
            return PathUtils$$ExternalSyntheticApiModelOutline0.m70m(context.getSystemService(PathUtils$$ExternalSyntheticApiModelOutline0.m$10()));
        }
        return null;
    }
