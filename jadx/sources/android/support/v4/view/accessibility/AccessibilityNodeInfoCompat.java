...
import android.support.v4.view.ViewCompat$$ExternalSyntheticApiModelOutline5;
...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        public int getId() {
            if (Build.VERSION.SDK_INT >= 21) {
                return ViewCompat$$ExternalSyntheticApiModelOutline5.m209m(this.mAction).getId();
            }
            return 0;
        }
        ...
        public CharSequence getLabel() {
            if (Build.VERSION.SDK_INT >= 21) {
                return ViewCompat$$ExternalSyntheticApiModelOutline5.m209m(this.mAction).getLabel();
            }
            return null;
        }
    }
    ...
    public static class CollectionInfoCompat {
        ...
        public int getColumnCount() {
            if (Build.VERSION.SDK_INT >= 19) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m(this.mInfo).getColumnCount();
            }
            return 0;
        }
        ...
        public int getRowCount() {
            if (Build.VERSION.SDK_INT >= 19) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m(this.mInfo).getRowCount();
            }
            return 0;
        }
        ...
        public boolean isHierarchical() {
            if (Build.VERSION.SDK_INT >= 19) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m(this.mInfo).isHierarchical();
            }
            return false;
        }
        ...
        public int getSelectionMode() {
            if (Build.VERSION.SDK_INT >= 21) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m(this.mInfo).getSelectionMode();
            }
            return 0;
        }
    }
    ...
    public static class CollectionItemInfoCompat {
        ...
        public int getColumnIndex() {
            if (Build.VERSION.SDK_INT >= 19) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m231m(this.mInfo).getColumnIndex();
            }
            return 0;
        }
        ...
        public int getColumnSpan() {
            if (Build.VERSION.SDK_INT >= 19) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m231m(this.mInfo).getColumnSpan();
            }
            return 0;
        }
        ...
        public int getRowIndex() {
            if (Build.VERSION.SDK_INT >= 19) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m231m(this.mInfo).getRowIndex();
            }
            return 0;
        }
        ...
        public int getRowSpan() {
            if (Build.VERSION.SDK_INT >= 19) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m231m(this.mInfo).getRowSpan();
            }
            return 0;
        }
        ...
        public boolean isHeading() {
            if (Build.VERSION.SDK_INT >= 19) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m231m(this.mInfo).isHeading();
            }
            return false;
        }
        ...
        public boolean isSelected() {
            if (Build.VERSION.SDK_INT >= 21) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m231m(this.mInfo).isSelected();
            }
            return false;
        }
    }
    ...
    public static class RangeInfoCompat {
        ...
        public float getCurrent() {
            if (Build.VERSION.SDK_INT >= 19) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m232m(this.mInfo).getCurrent();
            }
            return 0.0f;
        }
        ...
        public float getMax() {
            if (Build.VERSION.SDK_INT >= 19) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m232m(this.mInfo).getMax();
            }
            return 0.0f;
        }
        ...
        public float getMin() {
            if (Build.VERSION.SDK_INT >= 19) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m232m(this.mInfo).getMin();
            }
            return 0.0f;
        }
        ...
        public int getType() {
            if (Build.VERSION.SDK_INT >= 19) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m232m(this.mInfo).getType();
            }
            return 0;
        }
    }
    ...
    public void addAction(AccessibilityActionCompat accessibilityActionCompat) {
        if (Build.VERSION.SDK_INT >= 21) {
            this.mInfo.addAction(ViewCompat$$ExternalSyntheticApiModelOutline5.m209m(accessibilityActionCompat.mAction));
        }
    }

    public boolean removeAction(AccessibilityActionCompat accessibilityActionCompat) {
        if (Build.VERSION.SDK_INT >= 21) {
            return this.mInfo.removeAction(ViewCompat$$ExternalSyntheticApiModelOutline5.m209m(accessibilityActionCompat.mAction));
        }
        return false;
    }
    ...
    public void setCollectionInfo(Object obj) {
        if (Build.VERSION.SDK_INT >= 19) {
            this.mInfo.setCollectionInfo(obj == null ? null : AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m(((CollectionInfoCompat) obj).mInfo));
        }
    }

    public void setCollectionItemInfo(Object obj) {
        if (Build.VERSION.SDK_INT >= 19) {
            this.mInfo.setCollectionItemInfo(obj == null ? null : AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m231m(((CollectionItemInfoCompat) obj).mInfo));
        }
    }
    ...
    public void setRangeInfo(RangeInfoCompat rangeInfoCompat) {
        if (Build.VERSION.SDK_INT >= 19) {
            this.mInfo.setRangeInfo(AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline1.m232m(rangeInfoCompat.mInfo));
        }
    }
    ...
    public List<AccessibilityNodeInfoCompat> findAccessibilityNodeInfosByViewId(String str) {
        if (Build.VERSION.SDK_INT >= 18) {
            List listFindAccessibilityNodeInfosByViewId = this.mInfo.findAccessibilityNodeInfosByViewId(str);
            ArrayList arrayList = new ArrayList();
