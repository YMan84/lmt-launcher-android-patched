...
public class ViewCompat {
            ...
            if (onApplyWindowInsetsListener == null) {
                ...
                view.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: android.support.v4.view.ViewCompat.1
                    ...
                    public WindowInsets onApplyWindowInsets(View view2, WindowInsets windowInsets) {
                        return ViewCompat$$ExternalSyntheticApiModelOutline5.m208m(WindowInsetsCompat.unwrap(onApplyWindowInsetsListener.onApplyWindowInsets(view2, WindowInsetsCompat.wrap(windowInsets))));
                    }
                });
            }
        }
    ...
    public static WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
        ...
        WindowInsets windowInsetsM208m = ViewCompat$$ExternalSyntheticApiModelOutline5.m208m(WindowInsetsCompat.unwrap(windowInsetsCompat));
        WindowInsets windowInsetsOnApplyWindowInsets = view.onApplyWindowInsets(windowInsetsM208m);
        if (windowInsetsOnApplyWindowInsets != windowInsetsM208m) {
            windowInsetsM208m = new WindowInsets(windowInsetsOnApplyWindowInsets);
        }
        return WindowInsetsCompat.wrap(windowInsetsM208m);
    }
    ...
    public static WindowInsetsCompat dispatchApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
        ...
        WindowInsets windowInsetsM208m = ViewCompat$$ExternalSyntheticApiModelOutline5.m208m(WindowInsetsCompat.unwrap(windowInsetsCompat));
        WindowInsets windowInsetsDispatchApplyWindowInsets = view.dispatchApplyWindowInsets(windowInsetsM208m);
        if (windowInsetsDispatchApplyWindowInsets != windowInsetsM208m) {
            windowInsetsM208m = new WindowInsets(windowInsetsDispatchApplyWindowInsets);
        }
        return WindowInsetsCompat.wrap(windowInsetsM208m);
    }
    ...
    public static void setPointerIcon(View view, PointerIconCompat pointerIconCompat) {
        if (Build.VERSION.SDK_INT >= 24) {
            view.setPointerIcon(ViewCompat$$ExternalSyntheticApiModelOutline5.m((Object) ViewCompat$$ExternalSyntheticApiModelOutline5.m(pointerIconCompat != null ? pointerIconCompat.getPointerIcon() : null)));
        }
    }
    ...
    public static void removeOnUnhandledKeyEventListener(View view, OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        View.OnUnhandledKeyEventListener onUnhandledKeyEventListenerM177m;
        if (Build.VERSION.SDK_INT >= 28) {
            Map map = (Map) view.getTag(R.id.tag_unhandled_key_listeners);
            if (map == null || (onUnhandledKeyEventListenerM177m = MenuCompat$$ExternalSyntheticApiModelOutline0.m177m(map.get(onUnhandledKeyEventListenerCompat))) == null) {
                return;
            }
            view.removeOnUnhandledKeyEventListener(onUnhandledKeyEventListenerM177m);
            return;
        }
        ArrayList arrayList = (ArrayList) view.getTag(R.id.tag_unhandled_key_listeners);
        if (arrayList != null) {
