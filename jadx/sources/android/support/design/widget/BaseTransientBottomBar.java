...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    protected BaseTransientBottomBar(ViewGroup viewGroup, View view, android.support.design.snackbar.ContentViewCallback contentViewCallback) {
        ...
        ViewCompat.setAccessibilityDelegate(snackbarBaseLayout, new AccessibilityDelegateCompat() { // from class: android.support.design.widget.BaseTransientBottomBar.3
    ...
    void animateViewIn() {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(translationYBottom) { // from class: android.support.design.widget.BaseTransientBottomBar.9
