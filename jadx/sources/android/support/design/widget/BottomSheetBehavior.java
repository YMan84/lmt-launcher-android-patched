...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public BottomSheetBehavior() {
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: android.support.design.widget.BottomSheetBehavior.2
            ...
            /* JADX WARN: Removed duplicated region for block: B:10:0x0025 A[PHI: r0
              0x0025: PHI (r0v11 int) = (r0v0 int), (r0v10 int), (r0v0 int) binds: [B:37:0x00a9, B:31:0x008e, B:8:0x001e] A[DONT_GENERATE, DONT_INLINE]] */
            @Override // android.support.v4.widget.ViewDragHelper.Callback
            /*
