...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Drawable.Callback {
    ...
    private void loadFromAttributes(AttributeSet attributeSet, int i, int i2) {
        ...
        setChipIconVisible(typedArrayObtainStyledAttributes.getBoolean(android.support.design.R.styleable.Chip_chipIconVisible, DEBUG));
        if (attributeSet != null && attributeSet.getAttributeValue(NAMESPACE_APP, "chipIconEnabled") != null && attributeSet.getAttributeValue(NAMESPACE_APP, "chipIconVisible") == null) {
            setChipIconVisible(typedArrayObtainStyledAttributes.getBoolean(android.support.design.R.styleable.Chip_chipIconEnabled, DEBUG));
        }
        ...
        setCloseIconVisible(typedArrayObtainStyledAttributes.getBoolean(android.support.design.R.styleable.Chip_closeIconVisible, DEBUG));
        if (attributeSet != null && attributeSet.getAttributeValue(NAMESPACE_APP, "closeIconEnabled") != null && attributeSet.getAttributeValue(NAMESPACE_APP, "closeIconVisible") == null) {
            setCloseIconVisible(typedArrayObtainStyledAttributes.getBoolean(android.support.design.R.styleable.Chip_closeIconEnabled, DEBUG));
        }
        ...
        setCheckable(typedArrayObtainStyledAttributes.getBoolean(android.support.design.R.styleable.Chip_android_checkable, DEBUG));
        setCheckedIconVisible(typedArrayObtainStyledAttributes.getBoolean(android.support.design.R.styleable.Chip_checkedIconVisible, DEBUG));
        if (attributeSet != null && attributeSet.getAttributeValue(NAMESPACE_APP, "checkedIconEnabled") != null && attributeSet.getAttributeValue(NAMESPACE_APP, "checkedIconVisible") == null) {
            setCheckedIconVisible(typedArrayObtainStyledAttributes.getBoolean(android.support.design.R.styleable.Chip_checkedIconEnabled, DEBUG));
        }
        ...
        setMaxWidth(typedArrayObtainStyledAttributes.getDimensionPixelSize(android.support.design.R.styleable.Chip_android_maxWidth, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED));
    ...
    private void drawText(Canvas canvas, Rect rect) {
        if (this.unicodeWrappedText != null) {
            ...
            int iSave = 0;
            boolean z = Math.round(getTextWidth()) > Math.round(this.rectF.width()) ? true : DEBUG;
            if (z) {
                iSave = canvas.save();
    ...
    private boolean onStateChange(int[] iArr, int[] iArr2) {
        ...
        boolean z2 = (hasState(getState(), R.attr.state_checked) && this.checkable) ? true : DEBUG;
    ...
    private static boolean isStateful(TextAppearance textAppearance) {
        if (textAppearance == null || textAppearance.textColor == null || !textAppearance.textColor.isStateful()) {
            return DEBUG;
        }
        return true;
    }
    ...
    public void setChipIconVisible(boolean z) {
        if (this.chipIconVisible != z) {
            ...
            if (zShowsChipIcon != zShowsChipIcon2 ? true : DEBUG) {
                if (zShowsChipIcon2) {
    ...
    public void setCloseIconVisible(boolean z) {
        if (this.closeIconVisible != z) {
            ...
            if (zShowsCloseIcon != zShowsCloseIcon2 ? true : DEBUG) {
                if (zShowsCloseIcon2) {
    ...
    public void setCheckedIconVisible(boolean z) {
        if (this.checkedIconVisible != z) {
            ...
            if (zShowsCheckedIcon != zShowsCheckedIcon2 ? true : DEBUG) {
