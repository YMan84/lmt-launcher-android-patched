...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static class VectorDrawableDelegateState extends Drawable.ConstantState {
        ...
        public Drawable newDrawable() {
            VectorDrawableCompat vectorDrawableCompat = new VectorDrawableCompat();
            vectorDrawableCompat.mDelegateDrawable = Chip$$ExternalSyntheticApiModelOutline0.m1m((Object) this.mDelegateState.newDrawable());
            return vectorDrawableCompat;
        }
        ...
        public Drawable newDrawable(Resources resources) {
            VectorDrawableCompat vectorDrawableCompat = new VectorDrawableCompat();
            vectorDrawableCompat.mDelegateDrawable = Chip$$ExternalSyntheticApiModelOutline0.m1m((Object) this.mDelegateState.newDrawable(resources));
            return vectorDrawableCompat;
        }
        ...
        public Drawable newDrawable(Resources resources, Resources.Theme theme) {
            VectorDrawableCompat vectorDrawableCompat = new VectorDrawableCompat();
            vectorDrawableCompat.mDelegateDrawable = Chip$$ExternalSyntheticApiModelOutline0.m1m((Object) this.mDelegateState.newDrawable(resources, theme));
            return vectorDrawableCompat;
        }
    ...
    private static class VGroup extends VObject {
        ...
        @Override // android.support.graphics.drawable.VectorDrawableCompat.VObject
        public boolean onStateChanged(int[] iArr) {
            boolean zOnStateChanged = VectorDrawableCompat.DBG_VECTOR_DRAWABLE;
            for (int i = 0; i < this.mChildren.size(); i++) {
